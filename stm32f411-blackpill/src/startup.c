...
void tamper_stamp_handler(void) __attribute__ ((alias("default_handler")));
...
uint32_t vectors[] __attribute__((section(".isr_vectors"))) =
{
  ...
  (uint32_t)can1_tx_handler,              /* 0x0000 008C */
  (uint32_t)can1_rx0_handler,             /* 0x0000 0090 */
  (uint32_t)can1_rx1_handler,             /* 0x0000 0094 */
  (uint32_t)can1_sce_handler,             /* 0x0000 0098 */
  ...
  (uint32_t)tim8_brk_tim12_handler,      /* 0x0000 00EC */
  (uint32_t)tim8_up_tim13_handler,       /* 0x0000 00F0 */
  (uint32_t)tim8_trg_com_tim14_handler,  /* 0x0000 00F4 */
  (uint32_t)tim8_cc_handler,             /* 0x0000 00F8 */
  ...
  (uint32_t)uart5_handler,               /* 0x0000 0114 */
  (uint32_t)tim6_dac_handler,            /* 0x0000 0118 */
